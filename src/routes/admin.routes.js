...
router.route("/staff-delete/:staffId").delete(verifyJWT, authorizeRoles("admin"), deleteStaffById)
router.route("/student-delete/:studentId").delete(verifyJWT, authorizeRoles("admin"), deleteStudentfById)
